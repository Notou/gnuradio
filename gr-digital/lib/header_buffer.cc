...
template uint8_t header_buffer::extract_field(int, int, bool, bool);
template uint16_t header_buffer::extract_field(int, int, bool, bool);
template uint32_t header_buffer::extract_field(int, int, bool, bool);
template uint64_t header_buffer::extract_field(int, int, bool, bool);
